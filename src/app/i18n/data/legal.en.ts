  ...
  Privacy: {
    ...
    dataProtectionAtAGlance: {
      ...
      generalNotes: {
        ...
        text: 'The following notes provide a simple overview of what happens to your personal data when you visit this website. Personal data is any data with which you can be personally identified. Detailed information on the subject of data protection can be found in our privacy policy listed below this text.',
      },
      dataCollection: {
        title: 'Data Collection on This Website',
        responsible: {
          title: 'Who is responsible for the data collection on this website?',
          text: 'The data processing on this website is carried out by the website operator. Their contact details can be found in the section "Information on the Responsible Party" in this privacy policy.',
        },
        howWeCollect: {
          title: 'How do we collect your data?',
          text1: 'Your data is collected on the one hand when you provide it to us. This could, for example, involve data you enter in a contact form.',
          text2:
        ...
        yourRights: {
          ...
          text2: 'For this and other questions on the topic of data protection, you can contact us at any time.',
        },
      },
    },
    hosting: {
      ...
      ionos: {
        title: 'IONOS',
        text1:
          'The provider is IONOS SE, Elgendorfer Str. 57, 56410 Montabaur (hereinafter IONOS). When you visit our website, IONOS collects various log files including your IP addresses. For details, see the IONOS privacy.',
    ...
    generalAndMandatory: {
      ...
      legalBasis: {
        title: 'General Information on Data Processing on This Website',
        text: 'If you have consented to data processing, we process your personal data on the basis of Art. 6 para. 1 lit. a GDPR or Art. 9 para. 2 lit. a GDPR, if special categories of data according to Art. 9 para. 1 GDPR are processed. In the case of explicit consent to the transfer of personal data to third countries, data processing is also based on Art. 49 para. 1 lit. a GDPR. If you have consented to the storage of cookies or to the access to information in your terminal device (e.g., via device fingerprinting), the data processing is additionally based on § 25 para. 1 TDDDG. The consent can be revoked at any time. If your data is required for the performance of a contract or for the implementation of pre-contractual measures, we process your data on the basis of Art. 6 para. 1 lit. b GDPR. Furthermore, we process your data if they are required for the fulfillment of a legal obligation on the basis of Art. 6 para. 1 lit. c GDPR. Data processing can also be based on our legitimate interest according to Art. 6 para. 1 lit. f GDPR. Information on the relevant legal basis in each individual case is provided in the following paragraphs of this privacy policy.',
      },
      recipients: {
      ...
      rightToObject: {
        title: 'Right to Object to the Collection of Data in Special Cases and to Direct Advertising (Art. 21 GDPR)',
        text1:
      ...
      rightToComplain: {
        ...
        text: 'In the event of violations of the GDPR, the persons concerned have the right to lodge a complaint with a supervisory authority, in particular in the Member State of their habitual residence, their place of work, or the place of the alleged violation. The right to lodge a complaint is without prejudice to any other administrative or judicial remedy.',
      },
      dataPortability: {
